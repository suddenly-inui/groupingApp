 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const XS="FirebaseError";class Dt extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=XS,Object.setPrototypeOf(this,Dt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ps.prototype.create)}}class Ps{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,i=this.errors[e],o=i?ZS(i,r):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new Dt(s,a,r)}}function ZS(n,e){return n.replace(eA,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const eA=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ys=new Ru("@firebase/app"),AA="@firebase/app-compat",CA="@firebase/analytics-compat",kA="@firebase/analytics",RA="@firebase/app-check-compat",DA="@firebase/app-check",NA="@firebase/auth",xA="@firebase/auth-compat",PA="@firebase/database",OA="@firebase/database-compat",MA="@firebase/functions",LA="@firebase/functions-compat",FA="@firebase/installations",UA="@firebase/installations-compat",VA="@firebase/messaging",$A="@firebase/messaging-compat",BA="@firebase/performance",qA="@firebase/performance-compat",jA="@firebase/remote-config",zA="@firebase/remote-config-compat",KA="@firebase/storage",GA="@firebase/storage-compat",WA="@firebase/firestore",HA="@firebase/firestore-compat",QA="firebase",YA="9.19.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tr=new Map,zo=new Map;function Bc(n,e){try{n.container.addComponent(e)}catch(t){ys.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function kv(n,e){n.container.addOrOverwriteComponent(e)}function Sr(n){const e=n.name;if(zo.has(e))return ys.debug(`There were multiple attempts to register component ${e}.`),!1;zo.set(e,n);for(const t of Tr.values())Bc(t,n);return!0}function ga(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function XA(n,e,t=Er){ga(n,e).clearInstance(t)}function ZA(){zo.clear()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rC="firebase-heartbeat-database",sC=1,Ko="firebase-heartbeat-store";let $l=null;function xv(){return $l||($l=IA(rC,sC,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(Ko)}}}).catch(n=>{throw zn.create("idb-open",{originalErrorMessage:n.message})})),$l}async function iC(n){try{return(await xv()).transaction(Ko).objectStore(Ko).get(Pv(n))}catch(e){if(e instanceof Dt)ys.warn(e.message);else{const t=zn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});ys.warn(t.message)}}}async function Im(n,e){try{const r=(await xv()).transaction(Ko,"readwrite");return await r.objectStore(Ko).put(e,Pv(n)),r.done}catch(t){if(t instanceof Dt)ys.warn(t.message);else{const r=zn.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});ys.warn(r.message)}}}function Pv(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pC={["no-app"]:"No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()",["invalid-app-argument"]:"firebase.{$appName}() takes either no argument or a Firebase App instance."},Tm=new Ps("app-compat","Firebase",pC);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ov(){const n=mC(fC);n.INTERNAL=Object.assign(Object.assign({},n.INTERNAL),{createFirebaseNamespace:Ov,extendNamespace:e,createSubscribe:Tv,ErrorFactory:Ps,deepExtend:Vc});function e(t){Vc(n,t)}return n}const gC=Ov();/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jm(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function Ls(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function Yw(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qu{constructor(){this._=void 0}}function ER(n,e,t){return n instanceof wi?function(r,s){const i={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:r.seconds,nanos:r.nanoseconds}}}};return s&&(i.fields.__previous_value__=s),{mapValue:i}}(t,e):n instanceof bs?v_(n,e):n instanceof Es?w_(n,e):function(r,s){const i=y_(r,s),o=tg(i)+tg(r._t);return Uh(i)&&Uh(r._t)?m_(o):p_(r.serializer,o)}(n,e)}function TR(n,e,t){return n instanceof bs?v_(n,e):n instanceof Es?w_(n,e):t}function y_(n,e){return n instanceof _i?Uh(t=e)||function(r){return!!r&&"doubleValue"in r}(t)?e:{integerValue:0}:null;var t}class wi extends Qu{}class bs extends Qu{constructor(e){super(),this.elements=e}}function v_(n,e){const t=__(e);for(const r of n.elements)t.some(s=>Mn(s,r))||t.push(r);return{arrayValue:{values:t}}}class Es extends Qu{constructor(e){super(),this.elements=e}}function w_(n,e){let t=__(e);for(const r of n.elements)t=t.filter(s=>!Mn(s,r));return{arrayValue:{values:t}}}class _i extends Qu{constructor(e,t){super(),this.serializer=e,this._t=t}}function tg(n){return Ue(n.integerValue||n.doubleValue)}function __(n){return ta(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class KR{getBundleMetadata(e,t){return dg(e).get(t).next(r=>{if(r)return{id:(s=r).bundleId,createTime:Ss(s.createTime),version:s.version};var s})}saveBundleMetadata(e,t){return dg(e).put({bundleId:(r=t).id,createTime:Ts(ze(r.createTime)),version:r.version});var r}getNamedQuery(e,t){return fg(e).get(t).next(r=>{if(r)return{name:(s=r).name,query:yf(s.bundledQuery),readTime:Ss(s.readTime)};var s})}saveNamedQuery(e,t){return fg(e).put(function(r){return{name:r.name,readTime:Ts(ze(r.readTime)),bundledQuery:r.bundledQuery}}(t))}}function dg(n){return ct(n,"bundles")}function fg(n){return ct(n,"namedQueries")}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eD{constructor(e,t){this.referenceDelegate=e,this.serializer=t}allocateTargetId(e){return this.Pn(e).next(t=>{const r=new As(t.highestTargetId);return t.highestTargetId=r.next(),this.Vn(e,t).next(()=>t.highestTargetId)})}getLastRemoteSnapshotVersion(e){return this.Pn(e).next(t=>G.fromTimestamp(new Me(t.lastRemoteSnapshotVersion.seconds,t.lastRemoteSnapshotVersion.nanoseconds)))}getHighestSequenceNumber(e){return this.Pn(e).next(t=>t.highestListenSequenceNumber)}setTargetsMetadata(e,t,r){return this.Pn(e).next(s=>(s.highestListenSequenceNumber=t,r&&(s.lastRemoteSnapshotVersion=r.toTimestamp()),t>s.highestListenSequenceNumber&&(s.highestListenSequenceNumber=t),this.Vn(e,s)))}addTargetData(e,t){return this.Sn(e,t).next(()=>this.Pn(e).next(r=>(r.targetCount+=1,this.Dn(t,r),this.Vn(e,r))))}updateTargetData(e,t){return this.Sn(e,t)}removeTargetData(e,t){return this.removeMatchingKeysForTargetId(e,t.targetId).next(()=>Gs(e).delete(t.targetId)).next(()=>this.Pn(e)).next(r=>(K(r.targetCount>0),r.targetCount-=1,this.Vn(e,r)))}removeTargets(e,t,r){let s=0;const i=[];return Gs(e).Z((o,a)=>{const c=go(a);c.sequenceNumber<=t&&r.get(c.targetId)===null&&(s++,i.push(this.removeTargetData(e,c)))}).next(()=>y.waitFor(i)).next(()=>s)}forEachTarget(e,t){return Gs(e).Z((r,s)=>{const i=go(s);t(i)})}Pn(e){return _g(e).get("targetGlobalKey").next(t=>(K(t!==null),t))}Vn(e,t){return _g(e).put("targetGlobalKey",t)}Sn(e,t){return Gs(e).put(V_(this.serializer,t))}Dn(e,t){let r=!1;return e.targetId>t.highestTargetId&&(t.highestTargetId=e.targetId,r=!0),e.sequenceNumber>t.highestListenSequenceNumber&&(t.highestListenSequenceNumber=e.sequenceNumber,r=!0),r}getTargetCount(e){return this.Pn(e).next(t=>t.targetCount)}getTargetData(e,t){const r=Is(t),s=IDBKeyRange.bound([r,Number.NEGATIVE_INFINITY],[r,Number.POSITIVE_INFINITY]);let i=null;return Gs(e).Z({range:s,index:"queryTargetsIndex"},(o,a,c)=>{const u=go(a);ka(t,u.target)&&(i=u,c.done())}).next(()=>i)}addMatchingKeys(e,t,r){const s=[],i=hr(e);return t.forEach(o=>{const a=Nt(o.path);s.push(i.put({targetId:r,path:a})),s.push(this.referenceDelegate.addReference(e,r,o))}),y.waitFor(s)}removeMatchingKeys(e,t,r){const s=hr(e);return y.forEach(t,i=>{const o=Nt(i.path);return y.waitFor([s.delete([r,o]),this.referenceDelegate.removeReference(e,r,i)])})}removeMatchingKeysForTargetId(e,t){const r=hr(e),s=IDBKeyRange.bound([t],[t+1],!1,!0);return r.delete(s)}getMatchingKeysForTargetId(e,t){const r=IDBKeyRange.bound([t],[t+1],!1,!0),s=hr(e);let i=se();return s.Z({range:r,Y:!0},(o,a,c)=>{const u=kn(o[1]),l=new O(u);i=i.add(l)}).next(()=>i)}containsKey(e,t){const r=Nt(t.path),s=IDBKeyRange.bound([r],[Vw(r)],!1,!0);let i=0;return hr(e).Z({index:"documentTargetsIndex",Y:!0,range:s},([o,a],c,u)=>{o!==0&&(i++,u.done())}).next(()=>i>0)}ne(e,t){return Gs(e).get(t).next(r=>r?go(r):null)}}function Gs(n){return ct(n,"targets")}function _g(n){return ct(n,"targetGlobal")}function hr(n){return ct(n,"targetDocuments")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sx(n){Tx(n,(e,t)=>new HI(e,t,new _x)),n.registerVersion(yx,vx)}Sx(ya);function rp(n,e){var t={};for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&e.indexOf(r)<0&&(t[r]=n[r]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,r=Object.getOwnPropertySymbols(n);s<r.length;s++)e.indexOf(r[s])<0&&Object.prototype.propertyIsEnumerable.call(n,r[s])&&(t[r[s]]=n[r[s]]);return t}const ao={FACEBOOK:"facebook.com",GITHUB:"github.com",GOOGLE:"google.com",PASSWORD:"password",PHONE:"phone",TWITTER:"twitter.com"},Ws={EMAIL_SIGNIN:"EMAIL_SIGNIN",PASSWORD_RESET:"PASSWORD_RESET",RECOVER_EMAIL:"RECOVER_EMAIL",REVERT_SECOND_FACTOR_ADDITION:"REVERT_SECOND_FACTOR_ADDITION",VERIFY_AND_CHANGE_EMAIL:"VERIFY_AND_CHANGE_EMAIL",VERIFY_EMAIL:"VERIFY_EMAIL"};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jg=new Ru("@firebase/auth");function Ac(n,...e){jg.logLevel<=me.ERROR&&jg.error(`Auth (${Os}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ms(n,e,t){return`firebase:${n}:${e}:${t}`}class ai{constructor(e,t,r){this.persistence=e,this.auth=t,this.userKey=r;const{config:s,name:i}=this.auth;this.fullUserKey=ms(this.userKey,s.apiKey,i),this.fullPersistenceKey=ms("persistence",s.apiKey,i),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?ps._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,r="authUser"){if(!t.length)return new ai(Gt(ki),e,r);const s=(await Promise.all(t.map(async u=>{if(await u._isAvailable())return u}))).filter(u=>u);let i=s[0]||Gt(ki);const o=ms(r,e.config.apiKey,e.name);let a=null;for(const u of t)try{const l=await u._get(o);if(l){const h=ps._fromJSON(e,l);u!==i&&(a=h),i=u;break}}catch{}const c=s.filter(u=>u._shouldAllowMigration);return!i._shouldAllowMigration||!c.length?new ai(i,e,r):(i=c[0],a&&await i._set(o,a.toJSON()),await Promise.all(t.map(async u=>{if(u!==i)try{await u._remove(o)}catch{}})),new ai(i,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fb(n,e=[]){let t;switch(n){case"Browser":t=Gg(Fe());break;case"Worker":t=`${Gg(Fe())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Os}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function m1(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function g1(n){const e=Xs(ho(n)).link,t=e?Xs(ho(e)).deep_link_id:null,r=Xs(ho(n)).deep_link_id;return(r?Xs(ho(r)).link:null)||r||t||e||n}class yl{constructor(e){var t,r,s,i,o,a;const c=Xs(ho(e)),u=(t=c.apiKey)!==null&&t!==void 0?t:null,l=(r=c.oobCode)!==null&&r!==void 0?r:null,h=m1((s=c.mode)!==null&&s!==void 0?s:null);R(u&&l&&h,"argument-error"),this.apiKey=u,this.operation=h,this.code=l,this.continueUrl=(i=c.continueUrl)!==null&&i!==void 0?i:null,this.languageCode=(o=c.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=c.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const t=g1(e);try{return new yl(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ks=class Cc{constructor(e){this.providerId=Cc.PROVIDER_ID,this.auth=at(e)}verifyPhoneNumber(e,t){return Sl(this.auth,e,W(t))}static credential(e,t){return gs._fromVerification(e,t)}static credentialFromResult(e){const t=e;return Cc.credentialFromTaggedObject(t)}static credentialFromError(e){return Cc.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{phoneNumber:t,temporaryProof:r}=e;return t&&r?gs._fromTokenResponse(t,r):null}};ks.PROVIDER_ID="phone";ks.PHONE_SIGN_IN_METHOD="phone";/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bs(n,e){return e?Gt(e):(R(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jP(n,e,t){return zP(n,e,t)}async function zP(n,e,t){const r=at(n);Gi(n,e,nr),await r._initializationPromise;const s=Bs(r,t);return await gp(s,r),s._openRedirect(r,e,"signInViaRedirect")}function KP(n,e,t){return GP(n,e,t)}async function GP(n,e,t){const r=W(n);Gi(r.auth,e,nr),await r.auth._initializationPromise;const s=Bs(r.auth,t);await gp(s,r.auth);const i=await qb(r);return s._openRedirect(r.auth,e,"reauthViaRedirect",i)}function WP(n,e,t){return HP(n,e,t)}async function HP(n,e,t){const r=W(n);Gi(r.auth,e,nr),await r.auth._initializationPromise;const s=Bs(r.auth,t);await vl(!1,r,e.providerId),await gp(s,r.auth);const i=await qb(r);return s._openRedirect(r.auth,e,"linkViaRedirect",i)}async function QP(n,e){return await at(n)._initializationPromise,Al(n,e,!1)}async function Al(n,e,t=!1){const r=at(n),s=Bs(r,e),o=await new $P(r,s,t).execute();return o&&!t&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}async function qb(n){const e=ja(`${n.uid}:::`);return n._redirectEventId=e,await n.auth._setRedirectUser(n),await n.auth._persistUserIfCurrent(n),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const NO=2e3;async function xO(n,e,t){var r;const{BuildInfo:s}=Rs();gn(e.sessionId,"AuthEvent did not contain a session ID");const i=await FO(e.sessionId),o={};return Wi()?o.ibi=s.packageName:Ba()?o.apn=s.packageName:ot(n,"operation-not-supported-in-this-environment"),s.displayName&&(o.appDisplayName=s.displayName),o.sessionId=i,id(n,t,e.type,void 0,(r=e.eventId)!==null&&r!==void 0?r:void 0,o)}async function PO(n){const{BuildInfo:e}=Rs(),t={};Wi()?t.iosBundleId=e.packageName:Ba()?t.androidPackageName=e.packageName:ot(n,"operation-not-supported-in-this-environment"),await Kb(n,t)}function OO(n){const{cordova:e}=Rs();return new Promise(t=>{e.plugins.browsertab.isAvailable(r=>{let s=null;r?e.plugins.browsertab.openUrl(n):s=e.InAppBrowser.open(n,Wx()?"_blank":"_system","location=yes"),t(s)})})}async function MO(n,e,t){const{cordova:r}=Rs();let s=()=>{};try{await new Promise((i,o)=>{let a=null;function c(){var h;i();const d=(h=r.plugins.browsertab)===null||h===void 0?void 0:h.close;typeof d=="function"&&d(),typeof(t==null?void 0:t.close)=="function"&&t.close()}function u(){a||(a=window.setTimeout(()=>{o(pt(n,"redirect-cancelled-by-user"))},NO))}function l(){(document==null?void 0:document.visibilityState)==="visible"&&u()}e.addPassiveListener(c),document.addEventListener("resume",u,!1),Ba()&&document.addEventListener("visibilitychange",l,!1),s=()=>{e.removePassiveListener(c),document.removeEventListener("resume",u,!1),document.removeEventListener("visibilitychange",l,!1),a&&window.clearTimeout(a)}})}finally{s()}}function LO(n){var e,t,r,s,i,o,a,c,u,l;const h=Rs();R(typeof((e=h==null?void 0:h.universalLinks)===null||e===void 0?void 0:e.subscribe)=="function",n,"invalid-cordova-configuration",{missingPlugin:"cordova-universal-links-plugin-fix"}),R(typeof((t=h==null?void 0:h.BuildInfo)===null||t===void 0?void 0:t.packageName)<"u",n,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-buildInfo"}),R(typeof((i=(s=(r=h==null?void 0:h.cordova)===null||r===void 0?void 0:r.plugins)===null||s===void 0?void 0:s.browsertab)===null||i===void 0?void 0:i.openUrl)=="function",n,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-browsertab"}),R(typeof((c=(a=(o=h==null?void 0:h.cordova)===null||o===void 0?void 0:o.plugins)===null||a===void 0?void 0:a.browsertab)===null||c===void 0?void 0:c.isAvailable)=="function",n,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-browsertab"}),R(typeof((l=(u=h==null?void 0:h.cordova)===null||u===void 0?void 0:u.InAppBrowser)===null||l===void 0?void 0:l.open)=="function",n,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-inappbrowser"})}async function FO(n){const e=UO(n),t=await crypto.subtle.digest("SHA-256",e);return Array.from(new Uint8Array(t)).map(s=>s.toString(16).padStart(2,"0")).join("")}function UO(n){if(gn(/[0-9a-zA-Z]+/.test(n),"Can only convert alpha-numeric strings"),typeof TextEncoder<"u")return new TextEncoder().encode(n);const e=new ArrayBuffer(n.length),t=new Uint8Array(e);for(let r=0;r<n.length;r++)t[r]=n.charCodeAt(r);return t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _p{constructor(){this.providerId="phone",this._delegate=new ks(Zb(ya.auth()))}static credential(e,t){return ks.credential(e,t)}verifyPhoneNumber(e,t){return this._delegate.verifyPhoneNumber(e,t)}unwrap(){return this._delegate}}_p.PHONE_SIGN_IN_METHOD=ks.PHONE_SIGN_IN_METHOD;_p.PROVIDER_ID=ks.PROVIDER_ID;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yM="auth-compat";function vM(n){n.INTERNAL.registerComponent(new On(yM,e=>{const t=e.getProvider("app-compat").getImmediate(),r=e.getProvider("auth");return new ld(t,r)},"PUBLIC").setServiceProps({ActionCodeInfo:{Operation:{EMAIL_SIGNIN:Ws.EMAIL_SIGNIN,PASSWORD_RESET:Ws.PASSWORD_RESET,RECOVER_EMAIL:Ws.RECOVER_EMAIL,REVERT_SECOND_FACTOR_ADDITION:Ws.REVERT_SECOND_FACTOR_ADDITION,VERIFY_AND_CHANGE_EMAIL:Ws.VERIFY_AND_CHANGE_EMAIL,VERIFY_EMAIL:Ws.VERIFY_EMAIL}},EmailAuthProvider:Br,FacebookAuthProvider:Tn,GithubAuthProvider:An,GoogleAuthProvider:Sn,OAuthProvider:ci,SAMLAuthProvider:lu,PhoneAuthProvider:_p,PhoneMultiFactorGenerator:Wb,RecaptchaVerifier:gM,TwitterAuthProvider:Cn,Auth:ld,AuthCredential:Hi,Error:Dt}).setInstantiationMode("LAZY").setMultipleInstances(!1)),n.registerVersion(JO,XO)}vM(ya);var wM="firebase",_M="9.19.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
